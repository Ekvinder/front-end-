...
export default function Singleproducts() {
  ...
  const ab = async () =>{
     let a = await fetch(`https://dummyjson.com/products/${id}`)
...
console.log(pr)
  ...
  <div className={`carousel-item ${i==0?'active':''}`} key={p}>
  <img className="w-100 h-100" src={p} alt="Image"/>
</div>
      ...
      <div className="col-lg-7 h-auto mb-30">
        <div className="h-100 bg-light p-30">
          ...
          <div className="d-flex mb-3">
            ...
            <small className="pt-1">{pr?.rating}</small>
          </div>
          <h3 className="font-weight-semi-bold mb-4">${pr?.price}</h3>
          <p className="mb-4">
        {pr.description}
          </p>
          <div className="d-flex mb-3">
        ...
        <div className="bg-light p-30">
          ...
          <div className="tab-content">
            ...
            <div className="tab-pane fade" id="tab-pane-2">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item px-0">
                      {pr.shippingInformation}
                    </li>
                    <li className="list-group-item px-0">
                      {pr.availabilityStatus}
                    </li>
                    <li className="list-group-item px-0">
                     {pr.warrantyInformation}
                    </li>
                    <li className="list-group-item px-0">
                      Takimata ea clita labore amet ipsum erat justo voluptua.
                      Nonumy.
            ...
            <div className="tab-pane fade" id="tab-pane-3">
              <div className="row">
                <div className="col-md-6">
                  {/* <h4 className="mb-4">1 review for {pr.title} {pr.reviews}</h4> */}
